...
const CSP = [
  ...
  "font-src 'self' data:",
  "connect-src 'self' https://*.clerk.accounts.dev https://api.razorpay.com https://api.iconify.design https://api.unisvg.com",
  "frame-src 'self' https://*.clerk.accounts.dev https://checkout.razorpay.com",
